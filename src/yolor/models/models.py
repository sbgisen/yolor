...
def get_yolo_layers(model):
    return [i for i, m in enumerate(model.module_list) if m.__class__.__name__ in [
        'YOLOLayer', 'JDELayer']]  # [89, 101, 113]
...
def convert(cfg='cfg/yolov3-spp.cfg', weights='weights/yolov3-spp.weights', saveto='converted.weights'):
    ...
    # from yolor.models import *; convert('cfg/yolov3-spp.cfg', 'weights/yolov3-spp.weights')
